	...
	<section class="infometry-industries" id="infometry-industries" aria-labelledby="infometry-industries-title">
		<div class="infometry-shell">
		  ...
		  <div class="infometry-card-grid infometry-industry-grid" id="infometry-industry-carousel" tabindex="0" aria-label="Infometry industry verticals">
				<article class="infometry-industry-item"><div class="infometry-mini-icon"><svg><use href="#i-tech"/></svg></div><h3>Hi-Tech</h3><p>Accelerate product innovation and recurring growth with real-time analytics and AI-ready data platforms.</p><div class="infometry-industry-focus"><span>Product Analytics</span><span>AI Acceleration</span></div><a class="infometry-industry-link" href="<?php echo esc_url( $technology_url ); ?>" aria-label="Explore Hi-Tech">Explore Hi-Tech <span aria-hidden="true">→</span></a></article>
				...
				<article class="infometry-industry-item"><div class="infometry-mini-icon"><svg><use href="#i-bank"/></svg></div><h3>Finance</h3><p>Modernize risk, fraud and customer intelligence with secure, governed data products built to scale.</p><div class="infometry-industry-focus"><span>Risk Analytics</span><span>Fraud Detection</span></div><a class="infometry-industry-link" href="<?php echo esc_url( $finance_url ); ?>" aria-label="Explore Finance">Explore Finance <span aria-hidden="true">→</span></a></article>
				<article class="infometry-industry-item"><div class="infometry-mini-icon"><svg><use href="#i-heart"/></svg></div><h3>Health Care</h3><p>Deliver trusted insights that improve patient outcomes, care coordination and operational efficiency.</p><div class="infometry-industry-focus"><span>Patient Insights</span><span>Data Governance</span></div><a class="infometry-industry-link" href="<?php echo esc_url( $healthcare_url ); ?>" aria-label="Explore Health Care">Explore Health Care <span aria-hidden="true">→</span></a></article>
				...
				<article class="infometry-industry-item"><div class="infometry-mini-icon"><svg><use href="#i-energy"/></svg></div><h3>Energy</h3><p>Turn asset, grid and operational data into reliable forecasting, performance and sustainability insights.</p><div class="infometry-industry-focus"><span>Asset Performance</span><span>Forecasting</span></div><a class="infometry-industry-link" href="<?php echo esc_url( $energy_url ); ?>" aria-label="Explore Energy">Explore Energy <span aria-hidden="true">→</span></a></article>
				...
				<article class="infometry-industry-item"><div class="infometry-mini-icon"><svg><use href="#i-pharma"/></svg></div><h3>Life Sciences</h3><p>Connect research, clinical and commercial data to accelerate discovery and improve compliant decisions.</p><div class="infometry-industry-focus"><span>Clinical Insights</span><span>Compliance</span></div><a class="infometry-industry-link" href="<?php echo esc_url( $life_sciences_url ); ?>" aria-label="Explore Life Sciences">Explore Life Sciences <span aria-hidden="true">→</span></a></article>
				<article class="infometry-industry-item"><div class="infometry-mini-icon"><svg><use href="#i-supply-chain"/></svg></div><h3>Supply Chain</h3><p>Improve planning, inventory visibility and logistics performance with connected operational intelligence.</p><div class="infometry-industry-focus"><span>Inventory Flow</span><span>Demand Planning</span></div><a class="infometry-industry-link" href="<?php echo esc_url( $supply_chain_url ); ?>" aria-label="Explore Supply Chain">Explore Supply Chain <span aria-hidden="true">→</span></a></article>
         </div>
