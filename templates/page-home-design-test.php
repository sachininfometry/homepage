...
$entertainment_url = home_url( '/entertainment/' );
$semiconductor_url = home_url( '/semiconductor/' );
	...
	<section class="infometry-industries" id="infometry-industries" aria-labelledby="infometry-industries-title">
		<div class="infometry-shell">
			...
			<div class="infometry-card-grid infometry-industry-grid" id="infometry-industry-carousel" tabindex="0" aria-label="Infometry industry verticals">
				...
				<article class="infometry-industry-item"><div class="infometry-mini-icon"><svg><use href="#i-building"/></svg></div><h3>Manufacturing</h3><p>Unify plant, quality and operations data to improve throughput, predict maintenance and reduce downtime.</p><div class="infometry-industry-focus"><span>Smart Factory</span><span>Predictive Ops</span></div><a href="<?php echo esc_url( $manufacturing_url ); ?>" aria-label="Explore Manufacturing">→</a></article>
				<article class="infometry-industry-item"><div class="infometry-mini-icon"><svg><use href="#i-bank"/></svg></div><h3>Finance</h3><p>Modernize risk, fraud and customer intelligence with secure, governed data products built to scale.</p><div class="infometry-industry-focus"><span>Risk Analytics</span><span>Fraud Detection</span></div><a href="<?php echo esc_url( $finance_url ); ?>" aria-label="Explore Finance">→</a></article>
				<article class="infometry-industry-item"><div class="infometry-mini-icon"><svg><use href="#i-heart"/></svg></div><h3>Health Care</h3><p>Deliver trusted insights that improve patient outcomes, care coordination and operational efficiency.</p><div class="infometry-industry-focus"><span>Patient Insights</span><span>Data Governance</span></div><a href="<?php echo esc_url( $healthcare_url ); ?>" aria-label="Explore Health Care">→</a></article>
				<article class="infometry-industry-item"><div class="infometry-mini-icon"><svg><use href="#i-entertainment"/></svg></div><h3>Entertainment</h3><p>Connect audience, content and channel data to improve engagement, monetization and campaign performance.</p><div class="infometry-industry-focus"><span>Audience Insights</span><span>Content Analytics</span></div><a href="<?php echo esc_url( $entertainment_url ); ?>" aria-label="Explore Entertainment">→</a></article>
				<article class="infometry-industry-item"><div class="infometry-mini-icon"><svg><use href="#i-energy"/></svg></div><h3>Energy</h3><p>Turn asset, grid and operational data into reliable forecasting, performance and sustainability insights.</p><div class="infometry-industry-focus"><span>Asset Performance</span><span>Forecasting</span></div><a href="<?php echo esc_url( $energy_url ); ?>" aria-label="Explore Energy">→</a></article>
				<article class="infometry-industry-item"><div class="infometry-mini-icon"><svg><use href="#i-chip"/></svg></div><h3>Semiconductor</h3><p>Unify fab, test and supply data to improve yield, quality, planning and production performance.</p><div class="infometry-industry-focus"><span>Yield Analytics</span><span>Quality Signals</span></div><a href="<?php echo esc_url( $semiconductor_url ); ?>" aria-label="Explore Semiconductor">→</a></article>
				<article class="infometry-industry-item"><div class="infometry-mini-icon"><svg><use href="#i-pharma"/></svg></div><h3>Life Sciences</h3><p>Connect research, clinical and commercial data to accelerate discovery and improve compliant decisions.</p><div class="infometry-industry-focus"><span>Clinical Insights</span><span>Compliance</span></div><a href="<?php echo esc_url( $life_sciences_url ); ?>" aria-label="Explore Life Sciences">→</a></article>
				<article class="infometry-industry-item"><div class="infometry-mini-icon"><svg><use href="#i-supply-chain"/></svg></div><h3>Supply Chain</h3><p>Improve planning, inventory visibility and logistics performance with connected operational intelligence.</p><div class="infometry-industry-focus"><span>Inventory Flow</span><span>Demand Planning</span></div><a href="<?php echo esc_url( $supply_chain_url ); ?>" aria-label="Explore Supply Chain">→</a></article>
			</div>
		</div>
	</section>
