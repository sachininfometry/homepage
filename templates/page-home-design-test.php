...
<main class="infometry-home-test" id="infometry-home-test">
	...
	<section class="infometry-hero" aria-labelledby="infometry-hero-title">
		...
		<div class="infometry-shell infometry-hero-grid">
			...
			<div class="infometry-dashboard-wrap" aria-label="INFOFISCUS Conversa analytics preview">
				<div class="infometry-dashboard-rail" aria-hidden="true"><span>☰</span><span class="is-active">▦</span><span>⌁</span><span>◫</span><span>⌾</span><span>⚙</span></div>
				<div class="infometry-dashboard">
					<div class="infometry-dashboard-head"><strong><img src="<?php echo esc_url( INFOMETRY_CT_URL . 'assets/images/infofiscus-conversa-logo.png' ); ?>" alt="INFOFISCUS Conversa"></strong><span>•••</span></div>
					<div class="infometry-question"><span>Why did revenue decline in the Western Region this quarter?</span><i>AI</i></div>
					<div class="infometry-answer">Revenue declined by 12% in the Western Region primarily due to stockouts in key products and lower repeat purchases.</div>
					<div class="infometry-widget-grid">
						<article class="infometry-widget"><small>Revenue Change</small><b>-12%</b><em>vs Last Quarter</em><svg class="infometry-line-chart" viewBox="0 0 140 54" aria-hidden="true"><polyline points="2,5 25,16 42,35 62,26 88,46 113,37 138,53"/></svg></article>
						<article class="infometry-widget"><small>Impact by Category</small><div class="infometry-donut"></div><ul><li><i></i>Stockouts <b>48%</b></li><li><i></i>Repeat Purchases <b>32%</b></li><li><i></i>Pricing <b>20%</b></li></ul></article>
						<article class="infometry-widget infometry-recommendations"><small>Top Recommendations</small><p>✓ Improve inventory availability</p><p>✓ Boost customer retention</p><p>✓ Optimize promotions</p></article>
					</div>
					<div class="infometry-ask"><span>Ask another question…</span><b>➤</b></div>
				</div>
			</div>
		</div>
	</section>
