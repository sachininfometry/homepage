	...
	<section class="infometry-products" id="infometry-products" aria-labelledby="infometry-products-title">
		<div class="infometry-shell">
			...
			<div class="infometry-card-grid infometry-product-grid" id="infometry-product-carousel" tabindex="0" aria-label="Infometry products">
				<article class="infometry-product-card is-featured is-conversa"><div class="infometry-card-icon has-brand-image"><img src="<?php echo esc_url( INFOMETRY_CT_URL . 'assets/images/infofiscus-conversa-mark.png' ); ?>" alt="INFOFISCUS Conversa"></div><span class="infometry-product-kicker">Conversational AI</span><h3>INFOFISCUS<br>Conversa</h3><p>Ask business questions in natural language and receive trusted answers, visualizations and recommendations from enterprise data in seconds.</p><div class="infometry-product-highlights"><span>Natural Language</span><span>Instant Insights</span></div><a href="<?php echo esc_url( $conversa_url ); ?>">Explore Conversa →</a></article>
				...
				<article class="infometry-product-card is-accelerator"><div class="infometry-card-icon blue"><svg><use href="#i-rocket"/></svg></div><span class="infometry-product-kicker">Analytics &amp; AI</span><h3>Data &amp; AI<br>Accelerators</h3><p>Move from idea to production faster with reusable frameworks for analytics, machine learning, governance and responsible enterprise AI.</p><div class="infometry-product-highlights"><span>Faster Delivery</span><span>Production Ready</span></div><a href="<?php echo esc_url( $accelerators_url ); ?>">Explore Accelerators →</a></article>
				<article class="infometry-product-card is-prebuilt"><div class="infometry-card-icon blue"><svg><use href="#i-grid"/></svg></div><span class="infometry-product-kicker">Pre-Built Analytics</span><h3>Pre-Built<br>Analytics Apps</h3><p>Deploy ready-to-use analytics modules for Finance, Sales and Marketing to accelerate reporting, surface insights and shorten time to value.</p><div class="infometry-product-highlights"><span>Finance Analytics</span><span>Sales &amp; Marketing</span></div><a href="<?php echo esc_url( $prebuilt_apps_url ); ?>">Explore Apps →</a></article>
				<article class="infometry-product-card is-snowflake"><div class="infometry-card-icon has-brand-image"><img src="<?php echo esc_url( INFOMETRY_CT_URL . 'assets/images/snowflake-product-mark.png' ); ?>" alt="Snowflake"></div><span class="infometry-product-kicker">Cloud Migration</span><h3>Snowflake<br>Migration</h3><p>Architect, design and migrate on-prem data platforms to Snowflake with proven frameworks, automation and modernization expertise.</p><div class="infometry-product-highlights"><span>Data Cloud</span><span>Migration</span></div><a href="<?php echo esc_url( $snowflake_sol_url ); ?>">Explore Snowflake &rarr;</a></article>
				<article class="infometry-product-card is-databricks"><div class="infometry-card-icon has-brand-image"><img src="<?php echo esc_url( INFOMETRY_CT_URL . 'assets/images/databricks-mark.png' ); ?>" alt="Databricks"></div><span class="infometry-product-kicker">Lakehouse AI</span><h3>Databricks<br>Expertise</h3><p>Accelerate AI, machine learning and analytics with Lakehouse-ready architecture, implementation and platform modernization services.</p><div class="infometry-product-highlights"><span>Lakehouse</span><span>AI/ML</span></div><a href="<?php echo esc_url( $databricks_url ); ?>">Explore Databricks &rarr;</a></article>
				<article class="infometry-product-card is-informatica"><div class="infometry-card-icon has-brand-image"><img src="<?php echo esc_url( INFOMETRY_CT_URL . 'assets/images/informatica-mark.png' ); ?>" alt="Informatica"></div><span class="infometry-product-kicker">IDMC Migration</span><h3>PowerCenter<br>to IDMC</h3><p>Modernize Informatica PowerCenter workloads with low-code migration utilities for repositories, mappings and cloud-ready pipelines.</p><div class="infometry-product-highlights"><span>Low-Code</span><span>IDMC</span></div><a href="<?php echo esc_url( $pc_to_idmc_url ); ?>">Explore IDMC &rarr;</a></article>
				<article class="infometry-product-card is-mulesoft"><div class="infometry-card-icon has-brand-image"><img src="<?php echo esc_url( INFOMETRY_CT_URL . 'assets/images/mulesoft-mark.png' ); ?>" alt="MuleSoft"></div><span class="infometry-product-kicker">API Integration</span><h3>MuleSoft + API<br>Integration</h3><p>Automate cloud and on-prem connections with API-led integration, reusable services and intelligent enterprise workflows.</p><div class="infometry-product-highlights"><span>Smart APIs</span><span>Integration</span></div><a href="<?php echo esc_url( $mulesoft_url ); ?>">Explore MuleSoft &rarr;</a></article>
				<article class="infometry-product-card is-matillion"><div class="infometry-card-icon has-brand-image"><img src="<?php echo esc_url( INFOMETRY_CT_URL . 'assets/images/matillion-mark.png' ); ?>" alt="Matillion"></div><span class="infometry-product-kicker">Cloud-Native ETL</span><h3>Matillion<br>Solutions</h3><p>Build scalable cloud ETL and transformation pipelines that prepare raw data faster for trusted analytics and business insights.</p><div class="infometry-product-highlights"><span>ETL</span><span>Transform</span></div><a href="<?php echo esc_url( $matillion_url ); ?>">Explore Matillion &rarr;</a></article>
				<article class="infometry-product-card is-dbt"><div class="infometry-card-icon has-brand-image"><img src="<?php echo esc_url( INFOMETRY_CT_URL . 'assets/images/dbt-mark.png' ); ?>" alt="dbt"></div><span class="infometry-product-kicker">ELT Modernization</span><h3>DBT Cloud/Core<br>Migration</h3><p>Move and optimize dbt projects with reusable templates, SQL enhancements and governed workflows for reliable ELT delivery.</p><div class="infometry-product-highlights"><span>dbt Cloud</span><span>Core</span></div><a href="<?php echo esc_url( $dbt_url ); ?>">Explore DBT &rarr;</a></article>
			</div>
		</div>
	</section>
	...
	<section class="infometry-industries" id="infometry-industries" aria-labelledby="infometry-industries-title">
		<div class="infometry-shell">
			...
			<div class="infometry-card-grid infometry-industry-grid" id="infometry-industry-carousel" tabindex="0" aria-label="Infometry industry verticals">
				<article class="infometry-industry-item"><div class="infometry-mini-icon"><svg><use href="#i-tech"/></svg></div><h3>Hi-Tech</h3><p>Accelerate product innovation and recurring growth with real-time analytics and AI-ready data platforms.</p><div class="infometry-industry-focus"><span>Product Analytics</span><span>AI Acceleration</span></div><a class="infometry-industry-link" href="<?php echo esc_url( $technology_url ); ?>" aria-label="Explore Hi-Tech"><span aria-hidden="true">→</span></a></article>
				<article class="infometry-industry-item"><div class="infometry-mini-icon"><svg><use href="#i-bag"/></svg></div><h3>Retail</h3><p>Connect shopper, inventory and merchandising data to improve experiences, loyalty and profitable growth.</p><div class="infometry-industry-focus"><span>Customer 360</span><span>Demand Planning</span></div><a class="infometry-industry-link" href="<?php echo esc_url( $retail_url ); ?>" aria-label="Explore Retail"><span aria-hidden="true">→</span></a></article>
				<article class="infometry-industry-item"><div class="infometry-mini-icon"><svg><use href="#i-building"/></svg></div><h3>Manufacturing</h3><p>Unify plant, quality and operations data to improve throughput, predict maintenance and reduce downtime.</p><div class="infometry-industry-focus"><span>Smart Factory</span><span>Predictive Ops</span></div><a class="infometry-industry-link" href="<?php echo esc_url( $manufacturing_url ); ?>" aria-label="Explore Manufacturing"><span aria-hidden="true">→</span></a></article>
				<article class="infometry-industry-item"><div class="infometry-mini-icon"><svg><use href="#i-bank"/></svg></div><h3>Finance</h3><p>Modernize risk, fraud and customer intelligence with secure, governed data products built to scale.</p><div class="infometry-industry-focus"><span>Risk Analytics</span><span>Fraud Detection</span></div><a class="infometry-industry-link" href="<?php echo esc_url( $finance_url ); ?>" aria-label="Explore Finance"><span aria-hidden="true">→</span></a></article>
				<article class="infometry-industry-item"><div class="infometry-mini-icon"><svg><use href="#i-heart"/></svg></div><h3>Health Care</h3><p>Deliver trusted insights that improve patient outcomes, care coordination and operational efficiency.</p><div class="infometry-industry-focus"><span>Patient Insights</span><span>Data Governance</span></div><a class="infometry-industry-link" href="<?php echo esc_url( $healthcare_url ); ?>" aria-label="Explore Health Care"><span aria-hidden="true">→</span></a></article>
				<article class="infometry-industry-item"><div class="infometry-mini-icon"><svg><use href="#i-entertainment"/></svg></div><h3>Entertainment</h3><p>Connect audience, content and channel data to improve engagement, monetization and campaign performance.</p><div class="infometry-industry-focus"><span>Audience Insights</span><span>Content Analytics</span></div></article>
				<article class="infometry-industry-item"><div class="infometry-mini-icon"><svg><use href="#i-energy"/></svg></div><h3>Energy</h3><p>Turn asset, grid and operational data into reliable forecasting, performance and sustainability insights.</p><div class="infometry-industry-focus"><span>Asset Performance</span><span>Forecasting</span></div><a class="infometry-industry-link" href="<?php echo esc_url( $energy_url ); ?>" aria-label="Explore Energy"><span aria-hidden="true">→</span></a></article>
				<article class="infometry-industry-item"><div class="infometry-mini-icon"><svg><use href="#i-chip"/></svg></div><h3>Semiconductor</h3><p>Unify fab, test and supply data to improve yield, quality, planning and production performance.</p><div class="infometry-industry-focus"><span>Yield Analytics</span><span>Quality Signals</span></div></article>
				<article class="infometry-industry-item"><div class="infometry-mini-icon"><svg><use href="#i-pharma"/></svg></div><h3>Life Sciences</h3><p>Connect research, clinical and commercial data to accelerate discovery and improve compliant decisions.</p><div class="infometry-industry-focus"><span>Clinical Insights</span><span>Compliance</span></div><a class="infometry-industry-link" href="<?php echo esc_url( $life_sciences_url ); ?>" aria-label="Explore Life Sciences"><span aria-hidden="true">→</span></a></article>
				<article class="infometry-industry-item"><div class="infometry-mini-icon"><svg><use href="#i-supply-chain"/></svg></div><h3>Supply Chain</h3><p>Improve planning, inventory visibility and logistics performance with connected operational intelligence.</p><div class="infometry-industry-focus"><span>Inventory Flow</span><span>Demand Planning</span></div><a class="infometry-industry-link" href="<?php echo esc_url( $supply_chain_url ); ?>" aria-label="Explore Supply Chain"><span aria-hidden="true">→</span></a></article>
			</div>
		</div>
	</section>
